...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="" target="_blank">Login</a></li>
	...
	<div class="heroe">
		...
		<h1>Welcome to Kunsarifan di Codeigniter<?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
...
<section>
	...
	<h1>Mulai belajar Pemrograman</h1>

	<p>Dimulai dari hal yang mendasar</p>
